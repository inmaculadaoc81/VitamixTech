...
module.exports=async(req,res)=>{
  if(req.method==="GET"){
    ...
    return res.status(200).json({
      ok:true,
      service:"VitamixTech contacto API",
  ...
  try{
    ...
    await transporter.sendMail({
      from:`"VitamixTech" <${process.env.SMTP_USER}>`,
      to:process.env.CONTACT_EMAIL||process.env.SMTP_USER,
      replyTo:email,
      subject:"Nueva consulta VitamixTech - vitamixtech.com.es",
      text:`Nueva consulta VitamixTech
...
${mensaje}`
    ...
    console.error("VitamixTech SMTP error",{
