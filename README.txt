...
REVISIÓN ADICIONAL (checklist unificado de la familia, a petición del cliente — repo 14/48):
...
- BUG REAL — botones del hero (.cta) con border-radius de 16px y sin
  ...
  sólido con #1f1f1f + texto blanco en el botón de teléfono (estilo
